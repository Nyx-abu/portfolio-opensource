...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        "display-2xl": ["clamp(2rem, 8vw, 9rem)", { lineHeight: "0.9", letterSpacing: "-0.04em", fontWeight: "700" }],
        "display-xl": ["clamp(1.75rem, 7vw, 7rem)", { lineHeight: "0.95", letterSpacing: "-0.03em", fontWeight: "700" }],
        "display-lg": ["clamp(1.5rem, 6vw, 5rem)", { lineHeight: "1", letterSpacing: "-0.025em", fontWeight: "700" }],
        "display-md": ["clamp(1.35rem, 4.5vw, 4rem)", { lineHeight: "1.05", letterSpacing: "-0.02em", fontWeight: "700" }],
        "display-sm": ["clamp(1.2rem, 3.5vw, 3rem)", { lineHeight: "1.1", letterSpacing: "-0.015em", fontWeight: "600" }],
